...
This is an interactive companion to the paper *Registers, Not Plans: What Lives in a Language Model's Workspace That Isn't on Its Tongue*, a working paper currently in revision. Every number here traces to a results JSON produced by a runnable script; the code, prompt sets, and per-experiment outputs are at [github.com/tao-hpu/jspace-replication](https://github.com/tao-hpu/jspace-replication). Figures are regenerated from those files.
